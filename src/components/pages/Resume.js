    ...
    <div>
      <div className='resumeSummary text-center' >
        ...
        <h5>
          ...
          <ul>Dynamic and successful successful career managing, sustaining, and improving systems</ul>
          <ul>Mission focused</ul>
        ...
        <div>
          ...
          <div className='typedResume'>
            <div>
              ...
              <ul>
                <h5>caseyfee3@gmail.com | (630) 800-7909 | Seattle, WA | <a href="linkedin.com/in/cfee"> LinkedIn </a>
                  | <a href="github.com/Caseyfee">GitHub</a></h5>
              </ul>
              <h2>Summary</h2>
              ...
              <ul>
              <ul>
                  <h3>Front of House Manager and Assistant Baker</h3>
                  <h4>Columbia City Bakery</h4>
                  <h5>Seattle, WA</h5>
                  <h6>May 2022 - Present</h6>
                  <ul>
                  <li>Took a position at my local bakery to explore a passion project and give myself the time and space to recalibrate my career goals while learning how to make delicious breads and pastries
                  </li>
                  </ul>
                </ul>
                <ul>
